...
#include "device_conv_softmax_conv_forward_implicit_gemm_v5r1_dlops_nc0hwc1_kc0yxc1_nk0hwk1.hpp"
...
int main(int argc, char* argv[])
{
    ...
    std::vector<std::size_t> in2_lengths_host(2);

    in2_lengths_host[0] = static_cast<std::size_t>(Ho);
    in2_lengths_host[1] = static_cast<std::size_t>(Wo);

    Tensor<out_data_t> in2(in2_lengths_host);
    Tensor<out_data_t> in3(in2_lengths_host);
    ...
    if(algo == ConvForwardAlgo::V5R1NCHWC)
    {
        ...
        device_convolution_softmax_conv_forward_implicit_gemm_v5r1_dlops_nc0hwc1_kc0yxc1_nk0hwk1<
            in_data_t,
            acc_data_t,
            bias_data_t,
            out_data_t,
